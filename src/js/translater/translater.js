...
export default function translater () {
    ...
    document.querySelectorAll('.advantages__list__item__title')[3].innerHTML = i18next.t('lang22');
    document.querySelectorAll('.advantages__list__item__title')[4].innerHTML = i18next.t('lang23');
    document.querySelectorAll('.advantages__list__item__title')[5].innerHTML = i18next.t('lang24');
    document.querySelectorAll('.advantages__list__item__title')[6].innerHTML = i18next.t('lang25');
    document.querySelectorAll('.advantages__list__item__title')[7].innerHTML = i18next.t('lang26');
    document.querySelectorAll('.advantages__list__item__title')[8].innerHTML = i18next.t('lang27');

    document.querySelectorAll('.advantages__list__item__title')[9].innerHTML = i18next.t('lang19');
    document.querySelectorAll('.advantages__list__item__title')[10].innerHTML = i18next.t('lang20');
    document.querySelectorAll('.advantages__list__item__title')[11].innerHTML = i18next.t('lang21');
    document.querySelectorAll('.advantages__list__item__title')[12].innerHTML = i18next.t('lang22');
    document.querySelectorAll('.advantages__list__item__title')[13].innerHTML = i18next.t('lang23');
    document.querySelectorAll('.advantages__list__item__title')[14].innerHTML = i18next.t('lang24');
    document.querySelectorAll('.advantages__list__item__title')[15].innerHTML = i18next.t('lang25');
    document.querySelectorAll('.advantages__list__item__title')[16].innerHTML = i18next.t('lang26');
    document.querySelectorAll('.advantages__list__item__title')[17].innerHTML = i18next.t('lang27');
    ...
    document.querySelectorAll('.advantages__list__item__text')[3].innerHTML = i18next.t('lang31');
    document.querySelectorAll('.advantages__list__item__text')[4].innerHTML = i18next.t('lang32');
    document.querySelectorAll('.advantages__list__item__text')[5].innerHTML = i18next.t('lang33');
    document.querySelectorAll('.advantages__list__item__text')[6].innerHTML = i18next.t('lang34');
    document.querySelectorAll('.advantages__list__item__text')[7].innerHTML = i18next.t('lang35');
    document.querySelectorAll('.advantages__list__item__text')[8].innerHTML = i18next.t('lang36');
    
    document.querySelectorAll('.advantages__list__item__text')[9].innerHTML = i18next.t('lang28');
    document.querySelectorAll('.advantages__list__item__text')[10].innerHTML = i18next.t('lang29');
    document.querySelectorAll('.advantages__list__item__text')[11].innerHTML = i18next.t('lang30');
    document.querySelectorAll('.advantages__list__item__text')[12].innerHTML = i18next.t('lang31');
    document.querySelectorAll('.advantages__list__item__text')[13].innerHTML = i18next.t('lang32');
    document.querySelectorAll('.advantages__list__item__text')[14].innerHTML = i18next.t('lang33');
    document.querySelectorAll('.advantages__list__item__text')[15].innerHTML = i18next.t('lang34');
    document.querySelectorAll('.advantages__list__item__text')[16].innerHTML = i18next.t('lang35');
    document.querySelectorAll('.advantages__list__item__text')[17].innerHTML = i18next.t('lang36');
